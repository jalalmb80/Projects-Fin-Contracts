  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-wrap gap-3">
        <button onClick={() => navigate('/cms/contracts?new=1')} className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 transition-colors">
          <Plus className="mr-2 h-4 w-4" />{t('عقد جديد', 'New Contract', lang)}
        </button>
        <Link to="/cms/contracts" className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
          <FileText className="mr-2 h-4 w-4" />{t('عرض الكل', 'View All', lang)}
        </Link>
        <Link to="/cms/clients" className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
          <Users className="mr-2 h-4 w-4" />{t('العملاء', 'Clients', lang)}
        </Link>
      </div>
